...
def openExpoFiles():
    ...
    ######### image
    image = mpimg.imread("C:/Users/Utilisateur/Documents/Scenoscope/IHM Python/plan_expo.png")
    image=np.flipud(image)
    #########
    
    ######### excel fichier acquisition
    document = xlrd.open_workbook("C:/Users/Utilisateur/Documents/Scenoscope/IHM Python/test_musee_EphebeV2.xls")
    ...
    document2 = xlrd.open_workbook("C:/Users/Utilisateur/Documents/Scenoscope/IHM Python/Tags_Musee_Agde.xls")
...
def save():
    ...
    sw_record=0
    workbook.save("C:/Users/Utilisateur/Documents/Scenoscope/IHM Python/TAG_DATA.xls")
...
def onclick(event):
    ...
    x=int(val[0])
    y=int(406-val[1])
    print("Single Click, Mouse position: (%s %s)" % (x, y))
...
#Personalisation
root.title("Scenoscope")
root.geometry("980x620")
root.iconbitmap("C:/Users/Utilisateur/Documents/Scenoscope/IHM Python/sceno_home.ico")
...
tk.Button(monCadre, text="Analyse",
          command=action1,fg="blue").pack(side=tk.LEFT,padx=5, pady=5)

tk.Button(monCadre, text="+",
          command=plusAngle,fg="purple").pack(side=tk.LEFT,padx=5, pady=5)

tk.Button(monCadre, text="-",
          command=minusAngle,fg="purple").pack(side=tk.LEFT,padx=5, pady=5)

tk.Button(monCadre, text="Record",
          command=record,fg="green").pack(side=tk.LEFT,padx=5, pady=5)

tk.Button(monCadre, text="Save",
          command=save, fg="green").pack(side=tk.LEFT,padx=5, pady=5)

greeting = tk.Label(text="Plan musée cap d'agde", font=("Courrier",15)).pack(side=tk.TOP, padx=5, pady=5)
